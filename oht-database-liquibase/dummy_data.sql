...
INSERT INTO public.pending_registration(
  ...
  moving_line_five, moving_line_six, moving_country_id, moving_postcode, benefit_type_id, issue_type, registration_status_id,
country_id, entitlement_date, requested_by, has_foreign_pension, creation_date, last_updated_date)
VALUES ('Mrs', 'Justine', null, 'Edwards', null, '10-08-1954', 2, 1, '12345679',
        ...
        null, null, 3, '378SD', 1, 'Main', 1, 3, current_date, 'Customer', 'no', current_date, current_date);
...
VALUES ('Mrs', 'Heather', null, 'Jones', null, '10-03-1957', 2, 1, '22345679',
        ...
        null, null, 3, '478SD', 1, 'Main', 1, 3, current_date, 'Customer', 'no', current_date, current_date);
